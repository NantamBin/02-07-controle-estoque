// src/FormularioAdicionarItem.tsx 
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input type="number" name="quantidade" value={novoItem.quantidade} onChange={handleChange} />  </div>
            <div>
                <label>Preço:</label>
                <input type="number" name="preco" value={novoItem.preco} onChange={handleChange} step="0.01" />  </div>
            <button type="submit">Adicionar Item</button>  </form>
    );
};
